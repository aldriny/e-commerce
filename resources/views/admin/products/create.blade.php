...
@section('content')
    <div class="d-flex justify-content-center">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5 text-center">@lang('messages.create_product_title')</h4>
                    <form class="forms-sample" method="post" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="productName" placeholder="@lang('messages.create_product_name')">
                        </div>
                        <div class="form-group">
                            <label for="productDescription">@lang('messages.create_product_description')</label>
                            <textarea class="form-control" name="description" id="productDescription" placeholder="@lang('messages.create_product_description')"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="productPrice">@lang('messages.create_product_price')</label>
                            <input type="number" step="0.01" class="form-control" name="price" id="productPrice" placeholder="@lang('messages.create_product_price')">
                        </div>
                        <div class="form-group">
                            <label for="productQuantity">@lang('messages.create_product_quantity')</label>
                            <input type="number" class="form-control" name="quantity" id="productQuantity" placeholder="@lang('messages.create_product_quantity')">
                        </div>
                        <div class="form-group">
