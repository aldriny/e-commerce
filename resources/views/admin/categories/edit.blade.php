...
@section('content')
    <div class="d-flex justify-content-center">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5 text-center">@lang('messages.edit_category_title')</h4>
                    <form class="forms-sample" method="post" action="{{ route('admin.categories.update', $category->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="exampleInputUsername1" placeholder="@lang('messages.create_category_placeholder')" value="{{ old('name', $category->name) }}">
                        </div>
